...
1) After downloading, execute 'bundle install' to ensure all gems, platforms and dependencies are available.
...
3) Run the program by accessing its path, i.e. 'bin/cli -f ../xkcd_tablexi/menu.txt'
  -- A test menu is included: menu.txt
 4) Run the Rspec by typing 'rspec'
  -- If version conflicts throw errors, use 'bundle exec rspec' to call the Gemfile included
```
